...
IO_WORKERS    = 16     # wątki do wczytywania z dysku (HDD: 4, SSD: 8-16)
BATCH_SIZE    = 128    # ile zdjęć trafia jednocześnie do OpenCLIP
QUEUE_MAXSIZE = 32     # ile batchów czeka w kolejce (pilnuje RAM)
